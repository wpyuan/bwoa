...
$(document).ready(function () {
	var falg=document.getElementById("sex").value;
	if(falg=='男'){
...
$(document).ready(function () {
	var falg=document.getElementById("status").value;
	if(falg=='1'){
		...
		<div id="saper-bd">
			...
			<div class="subfiled-content">
				<div class="tab-container" data-trigger="hover">
					<div class="tab">
						<a href="javascript:;" class="current">修改信息</a>
					</div>
					<div class="tab-content">
						<div class="tab-content-item">
							<form name="f1" id="f1"
								action="employee/alter.do"
								...
								<div id="form-left">
									...
									<div class="kv-item address clearfix">
										...
										<div class="kv-item-content">
											<div class="outer">
											 ...
											 <input name="addressDetail" type="text" placeholder="街道" value="${addressDetail}">
										</div>
									</div>
									...
									<div class="kv-item clearfix">
										<label>原职位：</label>
										<div class="kv-item-content">
											<input name="lastJob" type="text" placeholder="原职位" value="${employee.lastJob}">
										</div>
									</div>
									...
									<div class="kv-item clearfix">
										<label>现职位：</label>
										<div class="kv-item-content">
											<input name="nowJob" type="text" placeholder="原职位" value="${employee.nowJob}">
										</div>
									</div>
								</div>
								<!--
								...
								<div id="form-rigth">
									<div class="kv-item clearfix">
										...
										<div class="kv-item-content">
											<span class="choose"> <input name="sex"
												...
												<input type="hidden" id="sex" value="${employee.sex}">
											</span>
										</div>
									</div>
									...
									<div class="kv-item clearfix">
										<label>民族：</label>
										<div class="kv-item-content">
											<input name="nation" type="text" placeholder="民族" value="${employee.nation}">
										</div>
									</div>
									...
									<div class="kv-item clearfix">
										...
										<div class="kv-item-content">
											...
											<input type="hidden" id="status" value="${employee.status}">
										</div>
									</div>
								</div>
								<!--
