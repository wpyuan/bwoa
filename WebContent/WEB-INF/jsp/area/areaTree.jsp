...
<body>
	<!-- 菜单实现 -->
	<div class="zTreeDemoBackground left" style="position: absolute;left: 20px;width: 800px;height: 800px">
	    <ul id="treeDemo" class="ztree"></ul>
	</div>	
	<div style="position: absolute;left: 50%">
		<iframe src="" id="detail" width="600px" height="800px" frameborder="0"></iframe>
	</div>
</body>
</html>