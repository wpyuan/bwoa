/*! sapar - v0.1.0 - 2015-01-11 */(function($, undefined) {
    ...
    $.fn.extend({
		/**
		 * add by ynshen 扩展show，支持参数visibility（本质是通过样式控制visibility）
		 */
        _oldShow : $.fn.show,
        show : function(type) {
            if (type != "visibility") {
		...
		/**
		 * add by ynshen 扩展hide，支持参数visibility（本质是通过样式控制visibility）
		 */
        _oldHide : $.fn.hide,
        hide : function(type) {
            if (type != "visibility") {
	...
	/**
	 * add by ynshen 判断浏览器是否支持console对象
	...
	/**
	 * add by ynshen 扩展Array对象，增加删除数组中指定元素方法
	 */
...
(function($) {
    ...
    $.uedWidget('ued.Dialog', {
        options : /** @lends Dialog# */
        {
			 ...
			 * @type string
			 * @default null
			 * @example $("#dialog").uedDialog({ title :"string"}})
			 */
            title : null,
            /**
			 ...
			 * @type object
			 * @default null
			 * @example $("#dialog").uedDialog({buttons:["false":function(){
			 *          alert(2) },"true":function(){ alert(3) }]})
			 */
            buttons : null,
            /**
			 * 是否有遮罩，添加在body下,默认有
			 ...
			 * @type boolean
			 * @default true
			 * @example $("#dialog").uedDialog({modal:false})
			 */
            modal : false,
            /**
			 ...
			 * @type object
			 * @default null
			 * @example $("#dialog").uedDialog({position:[50,10]})
			 */
            position : null,
            /**
			 * dialog的宽度
			 ...
			 * @type int
			 * @default 300
			 * @example $("#dialog").uedDialog({width:500})
			 */
            width : 300,
            /**
			 * dialog的高度
			 ...
			 * @type int
			 * @default 200
			 * @example $("#dialog").uedDialog({height:500})
			 */
            height : 200,
            /**
			 * 是否可以拖拽
			 ...
			 * @type boolean
			 * @default true
			 * @example $("#dialog").uedDialog({isDrag:false})
			 */
            isDrag : true,
            /**
			 * 默认打开
			 ...
			 * @type boolean
			 * @default false
			 * @example $("#dialog").uedDialog({autoOpen:false})
			 */
            autoOpen : false,
            /**
			 ...
			 * @type string
			 * @default null
			 * @example $("#dialog").uedDialog({type:"success"})
			 */
            type : null,
            /**
			 * 提示信息
			 ...
			 * @type string
			 * @default null
			 * @example $("#dialog").uedDialog({message:"tishixingxing"})
			 */
            message : null,
			/*
			 * 弹窗关闭后的回调,默认为null
		...
		/*
		 * 弹窗拖动函数 @param {Object} self 弹窗对象 @param {Object}
		 * _define组件内部自定义对象。用来存放临时值
		 */
		...
		/*
		 * 给弹窗设置标题。 @param {String or Object} _title 弹窗标题
		 */
		...
		/*
		 * 给弹窗设置高度 @param {int} _height 弹窗高度
		 */
		...
		/*
		 * 给提示型弹窗设置提示信息 @param {String or Object} _message 提示弹窗的提示信息
		 */
		...
		/*
		 * 用于修改第一个button的默认函数 addBy xzjiang,update rbai @param {Object} _func
		 * 函数体 @param {string} _param
		 */
...
(function($) {
	/**
	 * select 下拉选择框渲染组件 author: yswang version: 1.0
	 */
	$.fn.iSelect = function(){
		return this.each(function () {
